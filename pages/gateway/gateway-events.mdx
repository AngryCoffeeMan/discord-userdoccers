...
| qos_token?        | string                                                   | The base64-encoded serialized [qos token](/resources/qos-token#qos-token-object) protobuf                                                                                                                                                          |
...
| Field   | Type          | Description                                                      |
| ------- | ------------- | ---------------------------------------------------------------- |
| ver     | integer       | The client heartbeat version (currently `31`)                    |
...
| qos_token ^1^                             | string                                                                                                                     | The base64-encoded serialized [derived qos token](/resources/qos-token#derived-qos-token-structure) protobuf                                                                                                                                                                  |
