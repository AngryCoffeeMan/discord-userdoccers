...
| qos_token?        | string                                                   | The base64-encoded [QoS token](/gateway/qos-token#qos-token-object) protobuf                                                                                                                                                                       |
...
| qos_token ^1^                             | string                                                                                                                     | The base64-encoded [derived QoS token](/gateway/qos-token#derived-qos-token-structure) protobuf                                                                                                                                                                               |
